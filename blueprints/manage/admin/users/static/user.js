function format(data) {
    let html = []
    html.push("<a href=\"/manage/admin/users/new_password/?id=" + data.id + "\" class=\"btn btn-primary btn-sm me-1\" role=\"button\" data-toggle=\"button\">Сгенирировать новый пароль</a>")
